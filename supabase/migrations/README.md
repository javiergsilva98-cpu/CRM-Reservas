...
| `0017_customer_marketing_consent.sql` | Sustituye `find_or_create_customer` (4 params) por una versión de 5 params con `p_gdpr_marketing`, para guardar el consentimiento de marketing del checkbox del formulario público | ⏳ pendiente |
| `0018_rate_limiting.sql` | Trigger que limita a 3 reservas seguidas por cliente en 15 min, y tabla `reservation_lookup_attempts` + límite de 10 intentos/15 min en `find_own_reservations`, para frenar abuso del formulario público y de la autogestión de reservas | ⏳ pendiente |
